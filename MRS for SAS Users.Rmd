...
```{r}
download.file("https://alizaidi.blob.core.windows.net/training/yellow_tripdata_2015.xdf", destfile = "../R-cadence/data/yellow_tripdata_2015.xdf")
yellow_
...
```{r}
input_csv <- 'C:/Data/NYC_Taxi/yellow_tripdata_2015-01.csv'
...
for(ii in 2:3) { # get each month's data and append it to the first month's data
 input_csv <- sprintf('C:/Data/NYC_Taxi/yellow_tripdata_2015-%02d.csv', ii)
